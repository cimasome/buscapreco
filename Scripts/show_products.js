window.onload = function() {
    loadAndDisplayProducts('./Todos%20os%20produtos.json', 'mais-vendidos');
    loadAndDisplayProducts('./infoprodutos.json', 'info-produtos'); // Adicionando o segundo carregamento de produtos
};
